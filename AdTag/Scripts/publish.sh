...
bundle exec fastlane gym --verbose --include_bitcode true --include_symbols true --clean --workspace "../AdTag.xcworkspace" --scheme AdTag --archive_path $ARCHIVE_PATH --output_directory $OUTPUT_FOLDER --export_options $OPTIONS_PLIST
